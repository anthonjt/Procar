...
uint8_t* setServos(uint16_t s0, uint16_t s1){
    ...
    returnServos = genericSPI(setServosSend, setServosSendSize, setServosReturnSize);
...
uint8_t* setLED(uint8_t r, uint8_t g, uint8_t b){
    ...
    returnLED = genericSPI(setLEDSend, setLEDSendSize, setLEDReturnSize);
    
    return returnLED;
}

uint8_t* setCameraBrightness(uint8_t brightness){
    returnBrightness = genericSPI(setBrightnessSend, setBrightnessSendSize, setBrightnessReturnSize);
    
    return returnBrightness;
}

uint8_t* getResolution(){
    returnResolution = genericSPI(getResolutionSend, getResolutionSendSize, getResolutionReturnSize);
    
    return returnResolution;
}

uint8_t* getVersion(){
    returnVersion = genericSPI(getVersionSend, getVersionSendSize, getVersionReturnSize);
...
uint8_t* setLamp(uint8_t upper, uint8_t lower){
    ...
    returnLamp = genericSPI(setLampSend, setLampSendSize, setLampReturnSize);
    
    return returnLamp;
}

uint8_t* getFPS(){
    returnFPS = genericSPI(getFPSSend, getFPSSendSize, getFPSReturnSize);
    
    return returnFPS;
}

uint8_t* getMainFeatures(){
    returnMainFeatures = genericSPI(getMainFeaturesSend, getMainFeaturesSendSize, getMainFeaturesReturnSize);
...
uint8_t* setMode(uint8_t mode){
    ...
    returnMode = genericSPI(setModeSend, setModeSendSize, setModeReturnSize);
...
uint8_t* setNextTurn(uint16_t angle){
    ...
    returnNextTurn = genericSPI(setNextTurnSend, setNextTurnSendSize, setNextTurnReturnSize);
...
uint8_t* setDefaultTurn(uint16_t angle){
    ...
    returnDefaultTurn = genericSPI(setDefaultTurnSend, setDefaultTurnSendSize, setDefaultTurnReturnSize);
...
uint8_t* setVector(uint8_t angle){
    ...
    returnVector = genericSPI(setVectorSend, setVectorSendSize, setVectorReturnSize);
    
    return returnVector;
}

uint8_t* reverseVector(){
    returnreverseVector = genericSPI(reverseVectorSend, reverseVectorSendSize, reverseVectorReturnSize);
